...
_STATUS_BY_ERROR: dict[type[DomainError], int] = {
    ...
    PharmacySupplierNotFoundError: status.HTTP_404_NOT_FOUND,
    PharmacySupplierCodeAlreadyExistsError: status.HTTP_409_CONFLICT,
    ...
    TpaNotFoundError: status.HTTP_404_NOT_FOUND,
    TpaCodeAlreadyExistsError: status.HTTP_409_CONFLICT,
    InsuranceClaimNotFoundError: status.HTTP_404_NOT_FOUND,
    CertificateNotFoundError: status.HTTP_404_NOT_FOUND,
    CertificatePatientNotFoundError: status.HTTP_404_NOT_FOUND,
    CertificateDoctorNotFoundError: status.HTTP_404_NOT_FOUND,
    ...
    WardNotFoundError: status.HTTP_404_NOT_FOUND,
    BedNotFoundError: status.HTTP_404_NOT_FOUND,
    AdmissionNotFoundError: status.HTTP_404_NOT_FOUND,
    BedNotAvailableError: status.HTTP_409_CONFLICT,
    PatientAlreadyAdmittedError: status.HTTP_409_CONFLICT,
    WardCodeExistsError: status.HTTP_409_CONFLICT,
    NursingNoteNotFoundError: status.HTTP_404_NOT_FOUND,
    OtScheduleNotFoundError: status.HTTP_404_NOT_FOUND,
    NoUnbilledChargesError: status.HTTP_409_CONFLICT,
    ConsultationAlreadyAdmittedError: status.HTTP_409_CONFLICT,
    AccountNotFoundError: status.HTTP_404_NOT_FOUND,
    AccountCodeExistsError: status.HTTP_409_CONFLICT,
    VendorNotFoundError: status.HTTP_404_NOT_FOUND,
    VendorCodeExistsError: status.HTTP_409_CONFLICT,
    VendorBillNotFoundError: status.HTTP_404_NOT_FOUND,
    PaymentExceedsBillBalanceError: status.HTTP_409_CONFLICT,
}
...
_DEFAULT_MESSAGE_BY_ERROR: dict[type[DomainError], str] = {
    ...
    PharmacySupplierNotFoundError: "Pharmacy supplier not found.",
    PharmacySupplierCodeAlreadyExistsError: "A supplier with this code already exists.",
    ...
    TpaNotFoundError: "TPA not found.",
    TpaCodeAlreadyExistsError: "A TPA with this code already exists.",
    InsuranceClaimNotFoundError: "Insurance claim not found.",
    CertificateNotFoundError: "Medical certificate not found.",
    CertificatePatientNotFoundError: "The selected patient does not exist.",
    CertificateDoctorNotFoundError: "The selected doctor does not exist.",
    ...
    WardNotFoundError: "Ward not found.",
    BedNotFoundError: "Bed not found.",
    AdmissionNotFoundError: "Admission not found.",
    BedNotAvailableError: "Selected bed is not available.",
    PatientAlreadyAdmittedError: "Patient already has an active admission.",
    WardCodeExistsError: "A ward with this code already exists.",
    NursingNoteNotFoundError: "Nursing note not found.",
    OtScheduleNotFoundError: "OT schedule not found.",
    NoUnbilledChargesError: "No unbilled charges found for this admission.",
    ConsultationAlreadyAdmittedError: "This consultation already has an admission.",
    AccountNotFoundError: "Account not found.",
    AccountCodeExistsError: "Account code already exists.",
    VendorNotFoundError: "Vendor not found.",
    VendorCodeExistsError: "Vendor code already exists.",
    VendorBillNotFoundError: "Vendor bill not found.",
    PaymentExceedsBillBalanceError: "Payment exceeds bill balance.",
}
